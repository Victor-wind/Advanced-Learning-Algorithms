...
```python
temp_z = np.array([1.0, 2.0, 3.0, 4.0])
print(temp_z)
softmax_z = my_softmax(temp_z)
print(softmax_z)
plt.close("all")
...
```
    ...
    Epoch 1/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.9318
    Epoch 2/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.4062
    Epoch 3/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.1863
    Epoch 4/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.1046
    Epoch 5/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.0727
    Epoch 6/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.0576
    Epoch 7/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.0490
    Epoch 8/10
    ...
    <keras.callbacks.History at 0x7e64dc090c50>
...
print(f'[{p_nonpreferred [0][0]:.5f} {p_nonpreferred [0][1]:.5f} {p_nonpreferred [0][2]:.5f} {p_nonpreferred [0][3]:.5f}]')
print(p_nonpreferred [:2])
print("largest value", np.max(p_nonpreferred), "smallest value", np.min(p_nonpreferred))
```

    (2000, 4)
    [0.00273 0.00116 0.98817 0.00793]
    [[2.73e-03 1.16e-03 9.88e-01 7.93e-03]
     [9.92e-01 7.25e-03 2.45e-04 1.82e-04]]
    largest value 0.9999994 smallest value 8.841699e-10
...
```
    ...
    Epoch 1/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.9411
    Epoch 2/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.3588
    Epoch 3/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.1772
    Epoch 4/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.1118
    Epoch 5/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.0818
    Epoch 6/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.0655
    Epoch 7/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.0558
    Epoch 8/10
    63/63 [==============================] - 0s 1ms/step - loss: 0.0495
    Epoch 9/10
    ...
    <keras.callbacks.History at 0x7e64bc686310>
...
```
    ...
    two example output vectors:
     [[-1.75 -0.99  3.61 -0.18]
     [ 5.6   0.59 -3.91 -5.45]]
    largest value 12.919012 smallest value -7.414204
...
```
    ...
    two example output vectors:
     [[4.53e-03 9.67e-03 9.64e-01 2.17e-02]
     [9.93e-01 6.61e-03 7.30e-05 1.56e-05]]
    largest value 0.9999976 smallest value 4.078164e-09
...
```
    ...
    [-1.75 -0.99  3.61 -0.18], category: 2
    [ 5.6   0.59 -3.91 -5.45], category: 0
    [ 4.1   0.91 -2.83 -4.73], category: 0
    [-0.86  4.67 -1.91 -3.59], category: 1
    [-0.84 -2.2   4.54 -1.74], category: 2
